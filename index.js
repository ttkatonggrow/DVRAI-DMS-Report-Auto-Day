    ...
    <body>
        ...
        <div class="page">
            <div style="text-align: center; padding-top: 60px;">
                ...
                <div style="margin-top: 20px; font-size: 18px;">วันที่สิ้นสุด: ${dateStr} (รอบเวลา 06:00 - 18:00 น.)</div>
            </div>
